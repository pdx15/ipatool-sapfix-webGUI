...
### Способ 0: Встроенная вкладка «Установка на устройство»
Если в системе есть `ideviceinstaller` (libimobiledevice), откройте вкладку **«Установка на устройство»**, выберите подключенное устройство и `.ipa` файл, затем нажмите **«Установить на устройство»**. Подробное описание — в разделе «6. 📲 Установка .IPA на iPhone / iPad» выше.
